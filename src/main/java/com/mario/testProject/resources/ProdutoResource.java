...
import com.mario.testProject.resources.utils.URL;
...
public class ProdutoResource {
	...
	public ResponseEntity<Page<ProdutoDTO>> findPage(@RequestParam(value = "page", defaultValue = "0") Integer page,
		...
		String nameDecoded = URL.decodeParam(name);
		Page<ProdutoDTO> categoriasDto = service.search(nameDecoded, listCategorieIds, page, linesPerPage, orderBy, direction).map(ProdutoDTO::new);
